...
![A C64 running the famous 10 PRINT CHR$(205.5+RND(1)); : GOTO 10 line of code. ](image-7.png)
...
![10 PRINT for PICO-8](image-4.png)
...
![The PICO-8 editing tools.](image-5.png)
...
![The PICO-8 cartridge with the 10 PRINT code on it.](image-6.png)
