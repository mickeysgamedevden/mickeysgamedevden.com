...
![The P8SCII characters 154 to 253](./images/image.png)

Available are the 46 basic hiragana and katakana characters, support for 25 dakuten and han-dakuten (created with ゛and ゜as [P8SCII decoration character](#lexaloffle)), and the 36 combination characters with small versions of the characters YA, YU & YO (ゃ,ゅ,ょ). Katakana dakuten/han-dakuten and combination characters built with small versions of A, I, U, E, and O as well as VU are not available, but could be built manually with decoration characters, albeit only with the available versions of the katakana vowels (unless one would like to create the missing characters as [one-off characters](#lexaloffle)). 
...
![KANAGRID main view](./images/image-2.png)
...
![The basic hiragana and katakana characters](./images/image-1.png)
